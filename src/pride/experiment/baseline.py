...
class Baseline:
    ...
    def update_station_with_geophysical_displacements(
        ...
        augmented_eops = eop_interface.at_epoch(a_tstamps, unit="arcsec")
        ...
        shared_resources = {
            ...
            "eops": augmented_eops,
            "icrf2itrf": a_icrf2itrf,
            "seu2itrf": a_seu2itrf,
            "lat": a_lat,
            "lon": a_lon,
            "xsta_itrf": self.station.location(a_tstamps),
        }
        ...
        for model in displacement_models:
            ...
            resources = model.load_resources(a_tstamps, shared_resources)
            a_dx_itrf = model.calculate(a_tstamps, resources)
            a_dx_icrf = (
                a_icrf2itrf.swapaxes(-1, -2) @ a_dx_itrf[:, :, None]
            ).squeeze()
