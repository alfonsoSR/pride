...
def Vex(file: str | Path) -> VexContent:
    """Load a VEX file

    :param file: Path to the VEX file
    :return: VEX content as a MultiDict
    """
    ...
    if file.suffix not in (".vex", ".vix"):
        log.error(f"Failed to load VEX file: {file} has unexpected extension")
        exit(1)
